...
TRAIN_ANNOTATIONS_FILE="${TRAIN_IMAGE_DIR}/_annotations.coco.json"
VAL_ANNOTATIONS_FILE="${VAL_IMAGE_DIR}/_annotations.coco.json"
TESTDEV_ANNOTATIONS_FILE="${TEST_IMAGE_DIR}/_annotations.coco.json"