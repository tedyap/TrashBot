...
TRAIN_ANNOTATIONS_FILE="${TRAIN_DS_DIR}/_annotations.coco.json"
VAL_ANNOTATIONS_FILE="${VALID_DS_DIR}/_annotations.coco.json"
TESTDEV_ANNOTATIONS_FILE="${TEST_DS_DIR}/_annotations.coco.json"